...
const CompanySidebar = ({ activePath, onClose }) => {
    ...
    const navItems = [
        ...
        { path: 'candidates', label: 'Candidates', icon: User, route: '/dashboard/company/candidates' },
            ...
            <div className="sidebar-bottom-section">
                <div className="premium-upgrade-card">
                    ...
                    <button
                        ...
                        onClick={() => {
                            navigate('/dashboard/company/billing');
                            onClose();
                        }}
                    >
                        UPGRADE PLAN
                ...
                <div className="sidebar-bottom-links">
                    <Link to="/help" className="bottom-link-item" onClick={onClose}>
