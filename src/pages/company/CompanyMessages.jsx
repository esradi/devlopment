...
import { Send, MessageSquare, Search, MoreVertical, Paperclip, Smile, FileText, X, Download, Menu, Plus, User } from 'lucide-react';
...
const CompanyMessages = ({ userData }) => {
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            await messageService.create({ content: messageInput.trim(), receiver: activeConvId });
            setMessageInput('');
        } catch (err) {
    ...
    return (
        // ↓ THIS wrapper is the fix — pushes everything below the navbar
        <div className="company-messages-page">
            ...
            <div className={`messages-container ${activeConvId ? 'conv-active' : ''}`}>
                ...
                <div className="messages-main">
                    {activeConv ? (
                            ...
                            <div className="chat-header">
                                ...
                                <div className="chat-header-actions">
                                    <button className="chat-btn-premium" onClick={() => setShowCVModal(true)}>
                                        <FileText size={18} /> <span className="cv-label">View CV</span>
                                    </button>
                                        ...
                                        <div key={msg.id || idx} className={`message-row ${isMe ? 'me' : 'them'}`}>
                                            ...
                                            <div className={`message-bubble ${isMe ? 'sent' : 'received'}`}>
                                                ...
                                                {msg.message_type === 'file' && msg.attachment && (
                                                    ...
                                                    >
                                                        <div className="file-icon-box"><Paperclip size={18} /></div>
                        ...
                        <div className="no-chat-selected">
                            <div className="empty-state-icon"><MessageSquare size={64} /></div>
